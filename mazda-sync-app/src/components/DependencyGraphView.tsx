...
function buildGraph(taskStatuses: Map<string, string>): string {
  ...
  return `flowchart LR
    ...
    subgraph C05["💇 AI Hairstyle Salon（業務系）"]
      ...
      C05_5["LT広島vol.2発表<br>1-C-05-5"]:::${c('1-C-05-5')}
    ...
    subgraph B01_2g["🤝 関係構築"]
      B01_2_1["AI講座企画<br>1-B-01-2-1"]:::${c('1-B-01-2-1')}
      ...
      B01_2_6["NT広島2026<br>AI Salon展示<br>1-B-01-2-6"]:::${c('1-B-01-2-6')}
      B01_2_7["幟町中学校<br>教員向け講演<br>1-B-01-2-7"]:::${c('1-B-01-2-7')}
      B01_2_8["町民会館AI講座<br>初級編 4/17<br>1-B-01-2-8"]:::${c('1-B-01-2-8')}
